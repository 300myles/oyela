    ...
    <section className="pt-[8rem] md:py-14">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        ...
        <div className="w-full flex flex-col items-center gap-[1.56rem] justify-center mt-8 md:mt-[2.75rem]">
          ...
          <button onClick={() => router.push("/coach-app")} className="px-3 flex items-center gap-3 py-2 mb-4 rounded-lg font-semibold text-sm md:text-xl border-2 duration-150 text-gray-700 bg-white hover:bg-white hover:border-primary hover:text-primary">
            Continue
            <svg
